...
namespace micros.MultibankSolution
{
  partial class BusinessUnitBoxClientHandlers
  {
    ...
    public virtual void DisableMultibankProporties()
    {
      ...
      _obj.State.Properties.CurrenServerAddressmicros.IsVisible = false;
      
      _obj.State.Properties.ClientIdmicros.IsRequired = false;
      _obj.State.Properties.ClientSecretmicros.IsRequired = false;
      _obj.State.Properties.CurrenServerAddressmicros.IsRequired = false;
    ...
    public virtual void EnableMultibankProporties()
    {
      ...
      _obj.State.Properties.CurrenServerAddressmicros.IsRequired = true;
      ...
      _obj.State.Properties.CurrenServerAddressmicros.IsVisible = true;
      
      _obj.State.Properties.CertificateReceiptNotifications.IsVisible = false;
    }
  }
}